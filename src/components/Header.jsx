                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M20 4C11.1634 4 4 11.1634 4 20C4 28.8366 11.1634 36 20 36C28.8366 36 36 28.8366 36 20C36 11.1634 28.8366 4 20 4ZM0 20C0 8.95431 8.95431 0 20 0C31.0457 0 40 8.95431 40 20C40 31.0457 31.0457 40 20 40C8.95431 40 0 31.0457 0 20Z"
                            fill="currentColor"
                          />
                          <path
                            className="edit-icon-stroke"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M20 12C17.7909 12 16 13.7909 16 16C16 18.2091 17.7909 20 20 20C22.2091 20 24 18.2091 24 16C24 13.7909 22.2091 12 20 12ZM12 16C12 11.5817 15.5817 8 20 8C24.4183 8 28 11.5817 28 16C28 20.4183 24.4183 24 20 24C15.5817 24 12 20.4183 12 16Z"
                            fill="currentColor"
                          />
                          <path
                            className="edit-icon-stroke"
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M19.9999 29C15.5607 29 11.6819 31.4094 9.60402 35.0014L6.1416 32.9985C8.90506 28.2214 14.0751 25 19.9999 25C25.9246 25 31.0947 28.2214 33.8581 32.9985L30.3957 35.0014C28.3178 31.4094 24.439 29 19.9999 29Z"
                            fill="currentColor"
                          />
                        </svg>
