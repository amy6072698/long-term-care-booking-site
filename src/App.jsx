                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-md-7">
                        <div className="card-body">
                          <a href="intro.html">
                            <h5 className="card-title mt-7">{products.name}</h5>
                          </a>
                          <div className="address d-flex align-items-center mb-4">
                            ...
                            <p className="ms-1">{products.address}</p>
                          </div>
                          ...
                          <div className="card_comment d-flex justify-content-between mb-1">
                            ...
                            <div className="comment_right d-flex align-items-center">
                              <h6>
                                {products.roomCards?.[0]?.roomType ||
                                  "載入中..."}
                                剩餘床位：
                              </h6>{" "}
                              <h5>
                                {products.roomCards?.[0]?.availableBeds ||
                                  "載入中..."}
                              </h5>
                            </div>
                          </div>
