    ...
    return (
                      ...
                      {/* 渲染購物車資料 */}
      {
        cartsData.map((item,index)=>
          (<div className="card overflow-hidden mb-11" key={item.id} style={{maxWidth: "1296px"}}>
            <div className="row g-0">
              <div className="col-lg-5">
                <div className="checkbox-relative h-100">
                  <img src={item.product.images[0]} className="img-fluid card-img rounded-0 h-100" alt="building"/>
                ...
                <div className="card-body p-4">
                  ...
                  <div className="infor mb-3">
                    ...
                    <div className="address d-flex">
                      ...
                      <p className="fs-7 ps-1 mb-5">{item.product.address}</p>
                    </div>
                  </div>
                  {/* information */}
                  ...
                  <div className="card-text d-flex justify-content-between align-items-end mb-2">
                    <div className="beds fs-7">剩餘床位：<span className="last-bed">{item.product.roomCards[0].availableBeds+item.product.roomCards[1].availableBeds+item.product.roomCards[2].availableBeds}</span></div>
                    <div className="room-info text-end">
                      <p className="room-type fs-8">{item.product.roomCards[0].roomType}</p>
                      <p className="room-price fs-5">NTD {item.product.roomCards[0].price}</p>
                    </div>
                  </div>
