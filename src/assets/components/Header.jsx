      ...
      <header className="header sticky-top fixedTopControl">
        <nav className="navbar navbar-expand-lg py-0 bg-primary-110">
          <div className="container-lg container-fluid px-lg-4 px-0">
            <a className="navbar-brand py-lg-2 py-0 ms-6" href="index.html">
              <img src="src/assets/images/Logo/LB-Color.svg" alt="logo" className="d-inline-block w-100" style={{width: "196px", height: "70px"}}/>
            </a>
            <button className="navbar-toggler me-6 border-0 p-0 scrollControl" type="button" data-bs-toggle="collapse" data-bs-target="#headerNavbar" aria-controls="headerNavbar" aria-expanded="false" aria-label="Toggle navigation">
              <i className="bi bi-list hamColorToggler"></i>
            </button>
            <div className="collapse navbar-collapse bg-lg-primary-110 bg-white" id="headerNavbar">
              <ul className="navbar-nav ms-auto gap-lg-5 gap-0 flex-lg-row flex-column-reverse">
                <button className="navbar-toggler close border-0 rounded-0 mt-4 py-9" type="button" data-bs-toggle="collapse" data-bs-target="#headerNavbar" aria-controls="headerNavbar" aria-expanded="false" aria-label="Toggle navigation">
                  <i className="bi bi-x align-middle"></i>
                  <h6 className="d-inline align-middle">關閉此頁</h6>
                </button>
                <div className="d-lg-flex gap-lg-5 gap-0">
                  <li className="nav-item">
                    <a className="nav-link px-xl-5 px-lg-0" href="#">
                ...
                <div className="d-lg-flex gap-lg-5 gap-0">
                  <li className="nav-item">
                    <a className="nav-link px-xl-5 px-lg-0" href="order.html">
                      <svg className="d-inline edit-icon me-xl-4 me-lg-0 me-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path className="edit-icon-stroke" d="M12 16.0001V13.0001M12 13.0001V10.0001M12 13.0001H9M12 13.0001H15M4 16.8002V11.4522C4 10.9179 4 10.6506 4.06497 10.4019C4.12255 10.1816 4.2173 9.97307 4.34521 9.78464C4.48955 9.57201 4.69064 9.39569 5.09277 9.04383L9.89436 4.84244C10.6398 4.19014 11.0126 3.86397 11.4324 3.73982C11.8026 3.63035 12.1972 3.63035 12.5674 3.73982C12.9875 3.86406 13.3608 4.19054 14.1074 4.84383L18.9074 9.04383C19.3096 9.39569 19.5102 9.57201 19.6546 9.78464C19.7825 9.97307 19.8775 10.1816 19.9351 10.4019C20 10.6505 20 10.9184 20 11.4522V16.8037C20 17.9216 20 18.4811 19.7822 18.9086C19.5905 19.2849 19.2842 19.5906 18.9079 19.7823C18.4805 20.0001 17.9215 20.0001 16.8036 20.0001H7.19691C6.07899 20.0001 5.5192 20.0001 5.0918 19.7823C4.71547 19.5906 4.40973 19.2849 4.21799 18.9086C4 18.4807 4 17.9203 4 16.8002Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                  ...
                  <li className="nav-item">
                    <button className="nav-link px-xl-5 px-lg-0 w-100 text-start"  type="button" onClick={() => handleLoginModalOpen("login")}>
                      <svg className="d-inline edit-icon me-xl-4 me-lg-0 me-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path className="edit-icon-stroke" d="M12 15L15 12M15 12L12 9M15 12H4M9 7.24859V7.2002C9 6.08009 9 5.51962 9.21799 5.0918C9.40973 4.71547 9.71547 4.40973 10.0918 4.21799C10.5196 4 11.0801 4 12.2002 4H16.8002C17.9203 4 18.4796 4 18.9074 4.21799C19.2837 4.40973 19.5905 4.71547 19.7822 5.0918C20 5.5192 20 6.07899 20 7.19691V16.8036C20 17.9215 20 18.4805 19.7822 18.9079C19.5905 19.2842 19.2837 19.5905 18.9074 19.7822C18.48 20 17.921 20 16.8031 20H12.1969C11.079 20 10.5192 20 10.0918 19.7822C9.71547 19.5905 9.40973 19.2839 9.21799 18.9076C9 18.4798 9 17.9201 9 16.8V16.75" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
